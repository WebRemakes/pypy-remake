const HomeQuote = () => {
    return (
        <section className={"bg-base-200 w-full py-40"}>
                ...
                <div className={"relative z-10"}>
                    <p className={"text-xl text-gray-800 md:text-3xl md:leading-normal dark:text-white"}>
                        ...
                        <footer className="mt-6 space-y-4">
                            <div className="text-base font-semibold text-gray-800 dark:text-gray-400">Vilhjálmur Þorsteinsson, founder and CEO of Miðeind</div>
                            <div className="font-bold text-xs text-gray-500">Feb 2022</div>
                        </footer>
                    </p>
                </div>
            </blockquote>
